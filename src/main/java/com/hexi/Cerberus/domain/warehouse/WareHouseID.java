...
public class WareHouseID implements EntityID<UUID> {
    ...
    public WareHouseID(UUIDBasedEntityID id) {
        this.id = id.getId();
    }
    public WareHouseID(WareHouseID id) {
        this.id = id.getId();
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof WareHouseID)) return false;
        final WareHouseID other = (WareHouseID) o;
        if (!other.canEqual((WareHouseID) this)) return false;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof WareHouseID;
    }
