...
public class DepartmentController {
    ...
    DepartmentDomainToDtoMapper departmentDomainToDtoMapper;
    ...
    public ResponseEntity<List<DepartmentDetailsDTO>> fetch(@RequestParam(required = false) DepartmentID id) {
        if (id != null) {
            ...
            return ResponseEntity.ok(List.of(departmentDomainToDtoMapper.departmentToDetailsDTO(department.get())));
        } else {
